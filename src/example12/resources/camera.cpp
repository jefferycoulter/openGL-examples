...
void Camera::Update(float FOVdeg, float near_plane, float far_plane)
{
	// initialize matrices
...
void Camera::Matrix(Shader& shader, const char* uniform)
{
	...
	glUniformMatrix4fv(glGetUniformLocation(shader.shader_program, uniform), 1, GL_FALSE, glm::value_ptr(camera_matrix));
}
