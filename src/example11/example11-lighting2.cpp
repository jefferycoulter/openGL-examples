...
{ //     coordinates     /        colors          /    normals       
	...
	-0.5f, 0.0f, -0.5f,     0.83f, 0.00f, 0.44f,	 0.0f, -1.0f, 0.0f, // bottom side
	 0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, -1.0f, 0.0f, // bottom side
	 0.5f, 0.0f,  0.5f,     0.83f, 0.00f, 0.44f,	 0.0f, -1.0f, 0.0f, // bottom side
	...
	-0.5f, 0.0f, -0.5f,     0.00f, 0.70f, 0.44f,	 0.0f, 0.5f, -0.8f, // non-facing side
	 0.5f, 0.0f, -0.5f,     0.83f, 0.00f, 0.44f,	 0.0f, 0.5f, -0.8f, // non-facing side
	 0.0f, 0.8f,  0.0f,     0.00f, 0.86f, 0.06f,	 0.0f, 0.5f, -0.8f, // non-facing side

	 0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 0.8f, 0.5f,  0.0f, // right side
	 0.5f, 0.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 0.8f, 0.5f,  0.0f, // right side
	 0.0f, 0.8f,  0.0f,     0.92f, 0.86f, 0.76f,	 0.8f, 0.5f,  0.0f, // right side

	 0.5f, 0.0f,  0.5f,     0.00f, 0.70f, 0.00f,	 0.0f, 0.5f,  0.8f, // facing side
	-0.5f, 0.0f,  0.5f,     0.83f, 0.00f, 0.00f, 	 0.0f, 0.5f,  0.8f, // facing side
	 0.0f, 0.8f,  0.0f,     0.92f, 0.86f, 0.00f,	 .0f, 0.5f,  0.8f  // facing side
};
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(window_width, window_height, "OpenGL Example 11", NULL, NULL);
    if (window == NULL)
    {
	...
	Shader shader("../src/example11/resources/shaders/vert.glsl", "../src/example11/resources/shaders/frag.glsl");
